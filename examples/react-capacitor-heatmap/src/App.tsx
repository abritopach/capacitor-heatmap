...
import { IHeatmapOptions, IHeatmapType, HeatmapData, IHeatmapDrawOptions, HeatmapGradient } from 'capacitor-heatmap/dist/esm/models/models';
...
function App() {
    ...
    const initializeHeatmap = async () => {
        ...
        const data: HeatmapData = [[38,20,2],[38,690,3],[48,30,1],[48,40,1],[48,670,1],[58,640,1],[58,680,1],[67,630,1],[86,10,1],
        ...
        const optionsDraw: IHeatmapDrawOptions = {opacity: opacity, radius: radius, gradient: gradient};
        const resultDraw = await Heatmap.draw(optionsDraw);
        ...
        <div className={classes.root}>
            <CssBaseline />
                <AppBar position="fixed" className={clsx(classes.appBar, {[classes.appBarShift]: open})}>
                    <Toolbar>
                        ...
                        <Typography variant="h6" noWrap>React Test Capacitor Heatmap Plugin</Typography>
                </Toolbar>
            </AppBar>
            ...
            <main className={clsx(classes.content, {[classes.contentShift]: open})}>
                ...
                <div className={classes.heatmapContainer}>
                    <div id="testHeatmap" className={classes.testHeatmap}></div>
                </div>
                {/*
